...
public final class DescendingDiagonalBoardIterator extends BoardIterator {
    /**
     * Constructs a {@code DescendingDiagonalBoardIterator} to traverse the board diagonally
     * from top-left to bottom-right.
     * <p>
     * This iterator moves diagonally across the board, starting at the specified row and
     * moving in a downward-right direction. It retrieves board elements using
     ...
     */
    public DescendingDiagonalBoardIterator(
